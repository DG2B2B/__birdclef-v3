...
print("Taxon-aware temporal smoothing applied (V22: OOF-optimized alphas)")
...
if tax is not None:
    ...
    print("Taxonomic smoothing applied (V22: OOF-optimized alphas)")
else:
