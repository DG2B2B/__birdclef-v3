...
solutions = {
 'type_add' :'direct',
 'Models'   : [
  {'Model':'Model_2','subm':'subm_2.csv','weight':0.03,'xSED':['    ,    '],'LB':'0.917'},
  {'Model':'Model_3','subm':'subm_3.csv','weight':0.10,'xSED':['    ,    '],'LB':'0.928'},
  {'Model':'Model_4','subm':'subm_4.csv','weight':0.87,'xSED':[0.595,0.405],'LB':'0.947'}
 ]
}
...
submission = taxon_smooth(submission, texture_cols, event_cols, alpha_texture=0.25, alpha_event=0.08)
