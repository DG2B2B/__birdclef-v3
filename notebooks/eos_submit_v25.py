# === CELL 2 (V25: Model_2 REACTIVATED — diversité SED) ===
solutions = {
 'type_add' :'direct',
 'Models'   : [
...
print("Taxon-aware temporal smoothing applied (V25: +Model_2 diversity)")
...
if tax is not None:
    ...
    print("Taxonomic smoothing applied (V25: +Model_2 diversity)")
else:
