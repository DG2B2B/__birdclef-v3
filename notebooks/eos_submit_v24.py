# === CELL 2 (V24: Model_4 ONLY — diagnostic) ===
solutions = {
 'type_add' :'direct',
 'Models'   : [
  # Model_2 RETIRÉ, Model_3 RETIRÉ — test si Model_3 apporte ou non
  {'Model':'Model_4','subm':'subm_4.csv','weight':1.00,'xSED':[0.595,0.405],'LB':'0.947'}
 ]
}
...
if 'Model_4' in _ensemble_models:
    ...
    # V21: Optimized blend ratios — BirdNET+SED equalized at 25% each
...
def direct_add1():
    """Single model — just load and return."""
    df0 = pd.read_csv(_files_subm[0], index_col="row_id")
    return df0


def direct():
    if len(_ensemble_models) == 1:  return direct_add1()
...
print("Taxon-aware temporal smoothing applied (V24: Model_4 only)")
...
if tax is not None:
    ...
    print("Taxonomic smoothing applied (V24: Model_4 only)")
else:
